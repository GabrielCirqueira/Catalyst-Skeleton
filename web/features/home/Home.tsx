...
const features = [
  {
    ...
    description:
      'Login, cadastro, refresh token e revogação. Middleware de rota protegida no React e firewalls no Symfony.',
    chip: 'Auth',
  ...
  },
  {
    ...
    description:
      'Padrão Resultado para respostas consistentes. Serializer configurado, CORS e rate limiter prontos.',
    chip: 'Backend',
  ...
  },
  {
    ...
    description:
      'PHPStan nível 6, PHPCS, Biome, Husky e Commitlint. CI local que bloqueia código ruim antes do commit.',
    chip: 'DX',
  ...
  },
  {
    ...
    description:
      'Entity → Repository → Service → Controller. Separação clara de responsabilidades desde o primeiro arquivo.',
    chip: 'Estrutura',
  ...
  },
  {
    ...
    description:
      'Entidades com atributos PHP 8, migrations versionadas e repositórios tipados prontos para uso.',
    chip: 'ORM',
    chipColor: 'default' as const,
  },
  {
    ...
    description:
      'Async (Messenger + Supervisor), Observability (Sentry) e UI Extra (Motion + Recharts) ativados no setup.',
    chip: 'Modular',
    chipColor: 'accent' as const,
  },
]
...
const steps = [
  {
    ...
    desc: 'Execute ./scripts/setup.sh, escolha os módulos e configure .env automaticamente.',
  },
  {
    n: '02',
    title: 'Suba o ambiente',
    desc: 'docker compose up -d inicia backend, frontend, banco e proxy em segundos.',
  },
  {
    n: '03',
    title: 'Comece a codar',
    desc: 'Autenticação pronta, rotas protegidas, hot reload — foque na sua regra de negócio.',
  },
]
        ...
        <div className="relative max-w-5xl mx-auto px-6 py-24 flex flex-col items-center text-center gap-6">
          ...
          <div className="flex flex-col gap-2 motion-preset-slide-up motion-delay-200">
            ...
            <p className="text-xl text-muted max-w-xl">
              Fundação opinativa para aplicações full-stack{' '}
              <strong className="text-foreground">Symfony + React</strong>. Core enxuto, módulos
              opt-in, pronto para produção.
            </p>
          </div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-20">
        <div className="flex flex-col items-center gap-2 mb-12 text-center">
          ...
          <p className="text-muted max-w-md">
            Tudo que você precisa para começar. Nada que você não vai usar.
          </p>
        </div>
            ...
            <Card key={f.title} className="group hover:shadow-md transition-shadow">
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <Chip color={f.chipColor} variant="soft" size="sm">
                    {f.chip}
                  </Chip>
                </div>
