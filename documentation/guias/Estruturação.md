...
* **API do Sistema (`src/Infra/{Sistema}/{Sistema}API.php`)**: Classe concreta estendendo `{Sistema}Client` que expõe os métodos de ação de negócio da API (ex: `consultarStatus()`, `enviarCobranca()`).
