      ...
      <Container maxW={'7xl'} py={{ base: 8, md: 16 }} centerContent>
        ...
        >
          ...
          <Text color={textColor} maxW="2xl" fontSize="lg" lineHeight="tall">
            Uma estrutura leve e minimalista, unindo a interface interativa do React
            com o backend robusto do Symfony, para construir aplicações escaláveis e
            eficientes.
          </Text>
          ...
          <HStack spacing={6} mt={4}>
            <Button
              as={Link}
              href="https://github.com/GabrielCirqueira/Skeleton-Symfony-React"
              isExternal
              colorScheme="brand"
              variant="solid"
              size="lg"
        ...
        <VStack spacing={6} textAlign="center" w="full" bg={cardBg} p={10} rounded="xl" shadow="sm">
          ...
          <Text fontSize="lg" color={textColor} maxW="2xl">
            Clone o repositório e comece a desenvolver sua aplicação com essa arquitetura moderna hoje mesmo.
          </Text>
          <Button
            as={Link}
            href="https://github.com/GabrielCirqueira/Skeleton-Symfony-React"
...
function WorkStep({ icon, title, items, step }: { 
  icon: any, 
  title: string, 
  items: string[],
  step: string
...
function TechCard({ icon, name, description, color }: { 
  icon: any, 
  name: string, 
  description: string,
  color: string
  ...
  return (
    ...
    >
      ...
      <Heading size="md" mb={2} fontWeight="semibold">{name}</Heading>
...
function FeatureDetail({ icon, title, description }: { 
  ...
  return (
    <HStack align="start" spacing={6}>
      ...
      <Box>
        <Heading size="md" mb={2} fontWeight="semibold" color={iconColor}>{title}</Heading>
